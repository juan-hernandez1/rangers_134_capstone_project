...
#internal import 
from lft.models import User, db 
from lft.forms import RegisterForm, LoginForm, DeleteAccountForm
...
def delete_account():
    ...
    return render_template('delete_account.html', form=deleteaccountform)
